...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const timeouts = [
      ...
      setTimeout(() => setShowElements((prev) => ({ ...prev, name: true })), 400),
      setTimeout(() => setShowElements((prev) => ({ ...prev, role: true })), 700),
      setTimeout(() => setShowElements((prev) => ({ ...prev, description: true })), 1000),
      setTimeout(() => setShowElements((prev) => ({ ...prev, buttons: true })), 1300),
      setTimeout(() => setShowElements((prev) => ({ ...prev, doodle: true })), 1600),
    ];
